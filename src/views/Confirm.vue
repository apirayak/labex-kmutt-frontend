<template>
    ...
    <div class="align-items-center justify-content-center">
      <div style="display: flex" class="container">
        <div class="margin-wrapper table-wrapper custom-scrollbar">
          <div
            style="color: black;  display;inline-table;/* border: 2px solid rgb(255, 255, 255); */"
            class="robot text-center"
          >
            <select v-model="robotNumber">
              <option disabled value="">Please select robot number</option>
          ...
          <table>
            ...
            <tr>
              <td class="text-center date-text">Mon {{ this.test_text }}</td>
  ...
  <div
    ...
    aria-hidden="true"
  >
    <div v-if="this.robotNumber != '' " class="modal-dialog">
    ...
    <div class="modal-dialog" v-else>
      <div class="modal-content">
        ...
        <div style="background-color: #0880e8" class="modal-body">
          <form>
            <div style="color: #ffffff" class="mb-3">
              <p> กรุณาเลือกหุ่นยนต์ และเวลาที่ต้องการจอง</p>
            </div>
          </form>
        </div>
      </div>
