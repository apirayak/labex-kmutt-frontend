<template>
<img style="width:100%" class="step" src="../assets/step-a/B.png">
  <div class="page-learn-1">
      ...
      <div class="margin-wrapper">
          ...
          <div style="display: grid !important" class="container-wrapper">
            <div class="left-content">
              ...
              <div class="control mt-2">
                <button type="api" data-toggle="tooltip" data-placement="top" title="This button use for ....">Home</button><br /><br />
                <button type="api" data-toggle="tooltip" data-placement="top" title="This button use for ...." v-on:click="changeCommand('Pos 1')">Pos 1</button
                ><button type="api" data-toggle="tooltip" data-placement="top" title="This button use for ...." v-on:click="changeCommand('Pos 2')">Pos 2</button
                ><button type="api" data-toggle="tooltip" data-placement="top" title="This button use for ...." v-on:click="changeCommand('Pos 3')">Pos 3</button
                ><button type="api" data-toggle="tooltip" data-placement="top" title="This button use for ...." v-on:click="changeCommand('Pos E')">Pos E</button><br />

                <button type="api" data-toggle="tooltip" data-placement="top" title="This button use for ...." v-on:click="changeCommand('Pos E')">Pos E</button
                ><button type="api" data-toggle="tooltip" data-placement="top" title="This button use for ...." v-on:click="changeCommand('Pos 1')">Pos 1</button
                ><button type="api" data-toggle="tooltip" data-placement="top" title="This button use for ...." v-on:click="changeCommand('Pos 2')">Pos 2</button
                ><button type="api" data-toggle="tooltip" data-placement="top" title="This button use for ...." v-on:click="changeCommand('Pos 3')">Pos 3</button
                ><br /><br />
        ...
        data-bs-target="#Tutorial" class="item">
                ...
                <img src="../assets/Arrow.png" class="arrow" /><label for=""
                  style="border-bottom:2px solid black">Lab Tutorial</label
                >
              </div>
              <div class="item">
                ...
                <div class="btn-item">
                  <div>
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="exampleFormControlTextarea1" rows="11"  placeholder="Take your note here"></textarea>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-9">
                      <div class="msger control">
                        ...
                        <p class="message" v-for="message in this.$store.state.chatRoom1"  :key="message.id">{{this.$store.state.user.email}} : {{ message }}</p>
                        </main>
                        <input
                          v-model="msg"
                          type="text"
                    ...
                    >
                      <div style ="color:white;" class="text-center mt-3">
                        <h3>Member</h3>
                        <span>{{ this.$store.state.user.email }} (Controller)</span>
                      </div>
                    </div>
                  </div>
                </div>
...
export default {
  ...
  methods: {
    async changeController() {
      ...
      await axios
        .post(`robot/change_controller/`, fromDataControl)
        .then((res) => {
          console.log(res);
          if (res.data.success) {
    ...
    sendMessage() {
      ...
      console.log(msg_obj)
      this.$store.dispatch("pushMessage", msg_obj)
    },
    ...
    async changeCommand(command) {
      ...
      await axios
        .post(`robot/change_command/`, fromDataControl)
        .then((res) => {
          console.log(res);
          if (res.data.success) {
            this.customer = res.data.data;
...
.page-learn-1 button[type="api"]:hover {
  background: #fec061;
  color: #ffffff;
}

.page-learn-1 button[type="next"]:hover {
  background: #db4d4d;
  color: #ffffff;
}
.page-learn-1 button[type="done"]:hover {
  background: #db4d4d;
  color: #ffffff;
}
.page-learn-1 button[type="submit"]:hover {
  background: #db4d4d;
  color: #ffffff;
}
.page-learn-1 button[type="sheet"] {
  height: 100px;
  border: 0;
  padding: 10px 32px;
  color: white;
...
.page-learn-1 button[type="sheet"]:hover {
  background: #db4d4d;
  color: #ffffff;
}
